      ...
      const html = `
        ...
        <html>
          ...
          <body>
            ...
            <p class="meta">Version ${agreement.version}${acceptedAt ? ` &nbsp;|&nbsp; Accepted on ${formatDateIST(acceptedAt, { day: 'numeric', month: 'long', year: 'numeric' })}` : ''}</p>
            ...
            <View style={{ flex: 1 }}>
              ...
              {acceptedAt && (
                <Text style={styles.acceptedBannerDate}>
                  Accepted on{' '}
                  {formatDateIST(acceptedAt, { day: 'numeric', month: 'long', year: 'numeric' })}
                </Text>
              )}
            </View>
          </View>
